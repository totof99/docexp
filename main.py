...
print(f"Loaded {len(documents)} chunks in {elapsed_time:0.1f}s from PDF {filePath}")
...
print(f"Found {len(unique_documents_ids)} unique chunks")
...
elapsed_time = time.perf_counter() - start_time
print(f"Vector database filled with embeddings in {elapsed_time:0.1f}s")
